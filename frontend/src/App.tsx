...
type Screen = 'register' | 'consent' | 'goal' | 'assessment' | 'portrait' | 'list' | 'flow' | 'profile'
...
export default function App() {
  ...
  const inLearning = screen === 'list' || screen === 'flow' || screen === 'profile' || screen === 'goal' || screen === 'assessment' || screen === 'portrait'
